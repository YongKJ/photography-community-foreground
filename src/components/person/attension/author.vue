      ...
      <div class="tab-content js-tab-content">
        <div class style>
          <div class="vw_list_title">
            <bdo>{{ username }}</bdo> 关注了 <bdo>{{ authors.length }}</bdo> 人
          </div>
            ...
            >
              <div class="cc-user-img-con">
                <div class="w_default_avatar follower-avatar">
                  <a
                    @click="insurance(authors[i].next)"
              ...
              >
                <div class="cc_follow_btn" :ref="'cc_follow_btn_' + i">
                  <span
                    ...
                    :id="'cc_attension_' + i"
                    @click="
                      changeSpan('cc_follow_btn_' + i, i, authors[i].next)
                    "
                    @mouseenter="changeAttension(true, 'cc_attension_' + i)"
                    @mouseleave="changeAttension(false, 'cc_attension_' + i)"
                  >
  ...
  methods: {
    getAuthors() {
      this.$axios({
        ...
        method: "post",
        url: this.$store.state.localhostUrl + "/attention/author",
        data: {
